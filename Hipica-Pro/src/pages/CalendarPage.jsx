...
import { Calendar as CalendarIcon, Trophy, MapPin, Star, ChevronRight, Bell } from 'lucide-react';
...
const cardStyle = {
  display: 'flex', alignItems: 'center', gap: '30px', padding: '25px', 
...
const dateBoxStyle = {
  ...
  minWidth: '80px', height: '80px', background: 'rgba(234, 179, 8, 0.05)', borderRadius: '18px',
  color: '#eab308', border: '1px solid rgba(234, 179, 8, 0.2)'
};

const gradeBadgeStyle = (grade) => ({
  backgroundColor: grade === 'GI' ? '#eab308' : '#333',
  color: grade === 'GI' ? '#000' : '#fff',
...
const reminderBtnStyle = {
  ...
  background: 'none', color: 'var(--text-main)', fontSize: '0.75rem', fontWeight: 'bold',
